...
function PricingCard({data}) {
  ...
  return (
    <div style={{boxShadow: '3px 7px 4px rgba(0, 0, 0, 0.25)'}} className={`flex flex-col ${popular ? 'border border-[#2563EB] border-2 rounded-br-2xl  rounded-bl-3xl' : 'rounded-3xl'} relative pricing-con bg-white py-4 px-4 min-w-[271px] min-h-[350px]`}>
       {
        popular &&  
        <div style={{border: '2px solid #2563EB', boxSizing: 'content-box'}} className="popular-con flex items-center justify-center absolute -top-[30px] -left-[1px]  bg-[#2563EB] rounded-tr-full rounded-tl-full w-[100%] h-[28px]">
